        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AreaInSquareFeet = table.Column<decimal>(type: "decimal(12,2)", precision: 12, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorite_UserId_PropertyId",
                table: "Favorite",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_PropertyType_ListingType_Status",
                table: "Properties",
                columns: new[] { "PropertyType", "ListingType", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_PropertyImage_PropertyId_DisplayOrder",
                table: "PropertyImage",
                columns: new[] { "PropertyId", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_PropertyVisits_PropertyId_ScheduledAt",
                table: "PropertyVisits",
                columns: new[] { "PropertyId", "ScheduledAt" });

            migrationBuilder.CreateIndex(
                name: "IX_PropertyVisits_UserId_Status",
                table: "PropertyVisits",
